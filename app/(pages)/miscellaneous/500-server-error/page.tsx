...
const Miscellaneous500ServerError = () => {
  return (
    <div className="flex flex-col justify-center items-center text-center pt-[110px] px-[1.25rem]">
      <div className="flex flex-col justify-center items-center">
        <span className="text-3xl block">Oops, something went wrong!</span>
        <span className="text-sm text-muted-foreground mt-4 mb-6 block">There was an error with the internal server. Please contact your site administrator.</span>
...
export default Miscellaneous500ServerError