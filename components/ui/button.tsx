...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className,style, variant, size, asChild = false, ...props }, ref) => {
...
const LoadingButton = (props: any) => {
  ...
  return (
    <Button className="w-full" disabled {...props}>
      <span className="h-5 w-5 border-t-transparent border-solid animate-spin rounded-full border-2"></span>
