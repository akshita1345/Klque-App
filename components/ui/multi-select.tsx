            ...
            {selectedValues.length > 0 ? (
              <div className="flex justify-between items-center w-full">
                ...
                <div className="flex items-center justify-between">
                  <span
                    className="h-4 w-4 mx-2 cursor-pointer text-muted-foreground pointer-events-auto"
                    onMouseDown={(event) => {
                      event.preventDefault();
                      event.stopPropagation();
                    }}
                ...
                {options.map((option) => {
                  ...
                  return (
                    ...
                    >
                      <Checkbox
                        className={cn(
                          "mr-2 flex h-4 w-4 items-center justify-center rounded-sm data-[state=checked]:!bg-[#5D60FF]",
                        )}
                        checked={isSelected}
                      >
                      </Checkbox>
